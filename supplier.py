...
class supplierClass:
    def __init__(self,root):
       ...
       # All variables
        ...
        #===========Search Frame============================================
       #=======================options====================================
        lbl_search=Label(self.root,text="Invoice No.",font=("times new roman",15))
       ...
       # =================row2==========================================
        ...
        self.txt_desc.place(x=180,y=200,width=390,height=90)
        # ==========Buttons=============================
        btn_add=Button(self.root,text="Save",command=self.add,font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=100,y=370,width=110,height=35)
        btn_update=Button(self.root,text="Update",command=self.update,font=("goudy old style",15),bg="#4caf50",fg="white",cursor="hand2").place(x=220,y=370,width=110,height=35)
        btn_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),bg="red",fg="white",cursor="hand2").place(x=340,y=370,width=110,height=35)
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("goudy old style",15),bg="#607d8b",fg="white",cursor="hand2").place(x=460,y=370,width=110,height=35)
        # ============Employee Details====================
        emp_frame=Frame(self.root,bd=3,relief=RIDGE)
        emp_frame.place(x=610,y=120,width=470,height=350)
    ...
    def add(self):
        ...
        try:
            if self.var_sup_invoice.get()=="":
                ...
                row=cur.fetchone()
            if row!=None:
                messagebox.showerror("Error", "Invoice no. already exist. Try different.",parent=self.root)
            else:
