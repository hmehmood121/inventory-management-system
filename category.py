...
class categoryClass:
    def __init__(self,root):
        ...
        name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",18),bg="lightyellow").place(x=50,y=170,width=300)
        ...
        cat_frame.place(x=700,y=100,width=470,height=100)
    ...
    def delete(self):
        ...
        try:
            if self.var_cat_id.get()=="":
                messagebox.showerror("Error","Nothing to delete. Select category from list.",parent=self.root)
            else:
