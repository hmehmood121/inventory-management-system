...
class employeeClass:
       ...
       # All variables
        ...
        #=========================options====================================
              cmb_search=ttk.Combobox(SearchFrame,textvariable=self.var_searchby,values=("select","Name","Email","Contact"),state="readonly",justify=CENTER,font=("times new roman",15))
 ...
 # =================row4==========================================
        ...
        # ============Buttons=============================
              ...
              btn_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),bg="red",fg="white",cursor="hand2").place(x=740,y=305,width=110,height=28)
        ...
        # ============Employee Details====================
              ...
              self.EmployeeTable.heading("email",text="EMP Email")
       ...
       def search(self):
              ...
              try:
                     if self.var_searchby.get()=="Select":
                            messagebox.showerror("Error","Search by options",parent=self.root)
